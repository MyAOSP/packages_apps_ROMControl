...
import com.android.internal.util.action.NavRingHelpers;
...
public class NavRingTargets extends Fragment implements
        ...
        final AlertDialog d = new AlertDialog.Builder(getActivity())
                ...
                .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        Settings.System.putString(cr,
                                Settings.System.SYSTEMUI_NAVRING[0], ActionConstant.ACTION_ASSIST.value());
    ...
    private String getProperSummary(String uri) {
        ...
        if (TextUtils.isEmpty(uri) || ActionConstant.ACTION_NULL.equals(uri)) {
